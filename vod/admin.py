...
from .models import Video, Package, Provider, Edge, Stream, TaskState, Worker
...
class ProviderAdmin(ImportExportModelAdmin):
    ...
    list_display = ("name", 'active', "num_expired")
    readonly_fields = (
        "name",
        "vidra_task",
        "queue",
...
class PackageAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'created', 'created', 'name', 'original')
    list_filter = ('created', 'created', 'original')
    search_fields = ('name',)
...
class WorkerAdmin(admin.ModelAdmin):
    ...
    list_filter = ('created_at', 'modified_at', 'last_heartbeat', 'is_alive')
    search_fields = ('name',)
...
class TaskStateAdmin(admin.ModelAdmin):
    ...
    list_filter = ('started_at', 'completed_at', 'created_at', 'updated_at')
    date_hierarchy = 'created_at'
